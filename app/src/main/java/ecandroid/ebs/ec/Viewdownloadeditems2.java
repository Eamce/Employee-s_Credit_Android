...
public class Viewdownloadeditems2 extends AppCompatActivity {
...
//            addcart = b.getInt("addtocart");
        ...
        if(resultSet != null)
        {
            ...
            resultSet.close();
            DownloadedListAdapter adapter = new DownloadedListAdapter(this, R.layout.view_downloaded_row2, itemlist);
